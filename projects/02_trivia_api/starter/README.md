...
```js
GET '/categories'
- Fetches a dictionary of categories in which the keys are the ids and the value is the correct category.
- Request arguments: None
- Returns: An object with keys for the categories and the name of the categories as the value
{'1': "Science",
'2': "Art",
'3': "Geography",
'4': "History,
